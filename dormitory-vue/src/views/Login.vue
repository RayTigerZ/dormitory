				...
				<el-card shadow="never" class="login-card">
					<el-form ref="loginForm" :model="user" :rules="rules">
						...
						<el-form-item prop="account">
							<el-input type="text" placeholder="请输入帐号" prefix-icon="el-icon-user" v-model="user.account"></el-input>
						</el-form-item>
						<el-form-item prop="password">
							<el-input type="password" placeholder="请输入登录密码" prefix-icon="el-icon-lock" v-model="user.password"></el-input>
						</el-form-item>
